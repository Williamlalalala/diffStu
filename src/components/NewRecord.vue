...
<div>
  <el-autocomplete
    ...
    <div class="dynamicClass" :model="dynamic_data">
          <!--新建建档-->
         <div><p>studentId:</p><el-input  placeholder="studentId" v-model="dynamic_data.studentId"/></div>
         <div><p>teacherId:</p><el-input  placeholder="teacherId" v-model="dynamic_data.teacherId"/></div>
         <div><p>sex:</p><el-input  placeholder="sex" v-model="dynamic_data.sex"/></div>
         <div><p>name:</p><el-input  placeholder="name" v-model="dynamic_data.name"/></div>
         <div><p>major:</p><el-input  placeholder="major" v-model="dynamic_data.major"/></div>
         <div><p>grade:</p><el-input  placeholder="grade" v-model="dynamic_data.grade"/></div>
         <div><p>studentClass:</p><el-input  placeholder="studentClass" v-model="dynamic_data.studentClass"/></div>
         <div><p>politicalStatus:</p><el-input  placeholder="politicalStatus" v-model="dynamic_data.politicalStatus"/></div>
         <div><p>ethnicGroup:</p><el-input  placeholder="ethnicGroup" v-model="dynamic_data.ethnicGroup"/></div>
         <div><p>duty:</p><el-input  placeholder="duty" v-model="dynamic_data.duty"/></div>
         <div><p>dormitory:</p><el-input  placeholder="dormitory" v-model="dynamic_data.dormitory"/></div>
         <div><p>birthOrigin:</p><el-input  placeholder="birthOrigin" v-model="dynamic_data.birthOrigin"/></div>
         <div><p>familyAddress:</p><el-input  placeholder="familyAddress" v-model="dynamic_data.familyAddress"/></div>
         <div><p>contactWay:</p><el-input  placeholder="contactWay" v-model="dynamic_data.contactWay"/></div>
         <div><p>familyTelNumber:</p><el-input  placeholder="familyTelNumber" v-model="dynamic_data.familyTelNumber"/></div>
         <div><p>fatherTelNumber:</p><el-input  placeholder="fatherTelNumber" v-model="dynamic_data.fatherTelNumber"/></div>
         <div><p>motherTelNumber:</p><el-input  placeholder="motherTelNumber" v-model="dynamic_data.motherTelNumber"/></div>
         <div><p>familyCondition:</p><el-input  placeholder="familyCondition" v-model="dynamic_data.familyCondition"/></div>
         <div><p>studyCondition:</p><el-input  placeholder="studyCondition" v-model="dynamic_data.studyCondition"/></div>
         <div><p>healthCondition:</p><el-input  placeholder="healthCondition" v-model="dynamic_data.healthCondition"/></div>
         <div><p>lifeCondition:</p><el-input  placeholder="lifeCondition" v-model="dynamic_data.lifeCondition"/></div>
         <div><p>otherCondition:</p><el-input  placeholder="otherCondition" v-model="dynamic_data.otherCondition"/></div>
         <div><p>bulidingBasis:</p><el-input  placeholder="bulidingBasis" v-model="dynamic_data.bulidingBasis"/></div>
         <div><p>bulidingRecorder:</p><el-input  placeholder="bulidingRecorder" v-model="dynamic_data.bulidingRecorder"/></div>
         <div><p>bulidingTime:</p><el-input  placeholder="bulidingTime" v-model="dynamic_data.bulidingTime"/></div>
         <div><p>bulidingPerson:</p><el-input  placeholder="bulidingPerson" v-model="dynamic_data.bulidingPerson"/></div>
         <div><p>bulidingPersonDuty:</p><el-input  placeholder="bulidingPersonDuty" v-model="dynamic_data.bulidingPersonDuty"/></div>
